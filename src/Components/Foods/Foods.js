                ...
                <div className="text-center">
                    {
                        props.cart.length ? 
                        <Link to="/checkout">
                            <button  className="btn btn-danger btn-secondary btn-size">Check Out Your Food</button>
                        </Link>
                        :
                        <button disabled className="btn btn-secondary btn-size">Check Out Your Food</button>
