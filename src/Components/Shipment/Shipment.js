            ...
            <div className="row">
                <div className="col-md-5">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="py-5">
                        ...
                        <div className="form-group">
                            <textarea name="address" ref={register({ required: true })} placeholder="Add delivery instructor" className="form-control" cols="30" rows="2">{address}</textarea>
                            {errors.address && <span className="error"> Delivery Instructor Wants to Know More </span>}
                        </div>
                ...
                <div className="offset-md-2 col-md-5">
                    ...
                    <div className="cart-calculation">
                        ...
                        <p className="h5 d-flex justify-content-between"><span><bold>Total</bold></span> <span>${grandTotal.toFixed(2)}</span></p>
                        {
                            totalQuantity ?
                            todoor && road && flat && businessname && address ? 
                                ...
                                :
                                <button disabled className="btn btn-block btn-secondary">Place Order</button>
                            :
                            <button disabled className="btn btn-block btn-secondary">No Order Done Yet</button>
